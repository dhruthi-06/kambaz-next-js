...
<ol id="wd-my-favorite-recipe">
  <li>Take two eggs </li>
  <li>Crack the eggs add salt and pepper powder </li>
  <li>Mix all the contents together</li>
  <li>Take two bread pieces</li>
  <li>Heat the Pan and add butter to it</li>
  <li>Pour the egg mixture onto the pan and spread it like an omlet</li>
  <li>Place bread slices on top of the wet omelet, press lightly so it sticks.</li>
  <li>Flip Both the sides until they turn golden brown</li>
  <li>Serve Hot on The plate</li>
  </ol>
...
<select multiple defaultValue={["COMEDY", "SCIFI"]}>
  <option value="COMEDY">Comedy</option>
  <option value="DRAMA">Drama</option>
  <option value="SCIFI">Science Fiction</option>
  <option value="FANTASY">Fantasy</option>
...
<br></br>
Please
<a href="https://github.com/" id="wd-lipsum">click here</a>
to get dummy text<br/>
</div>
